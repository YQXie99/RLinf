...
class OpenPi0ForRLActionPrediction(PI0Pytorch, BasePolicy):
    ...
    def sample_mean_var_val(
        ...
        if (
            ...
            value_t = self._compute_value_from_suffix(suffix_out, task_ids=task_ids)
        else:
    ...
    def _compute_value_from_suffix(self, suffix_out, task_ids=None):
        ...
        if hasattr(self.value_head, "update_statistics"):
            return self.value_head(suffix_out_value, task_ids=task_ids)
